...
description: |
  Aggregating JudgeAI's round score predictions to generate final scorecard probability distributions.
twitter:
  - site: "@NateLatshaw"
  - creator: "@NateLatshaw"
author:
...
data_path <- '../2021-02-19-introducing-judgeai/files/output_files/'
functions_path <- './files/input_files/'
...
3. Repeat steps 1-2 100,000 times. This yields 100,000 final score samples.
