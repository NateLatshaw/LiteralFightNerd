...
# load data
rounds <- readRDS(paste0(data_path, 'round_stats_20211230.RDS'))
fights <- readRDS(paste0(data_path, 'fight_stats_20211230.RDS'))
...
# format data
tbl <- fights[WeightClass_clean != 'Catchweight' & F1_NoContest == F, 
...
tbl <- rbind(tbl, 
             fights[WeightClass_clean != 'Catchweight' & F1_NoContest == F & 
...
fnames <- c('Merab Dvalishvili', 'Bryce Mitchell', 'Curtis Blaydes', 'Islam Makhachev', 
            ...
            'Kevin Holland', 'Charles Rosa', 'Darren Stewart', 'Ed Herman', 
