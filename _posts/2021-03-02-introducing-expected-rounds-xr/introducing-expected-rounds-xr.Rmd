...
The aggregate xR and xR% for the fight are displayed in Table \@ref(tab:ufc-245-xr-percent) below. We see that Usman walked away with the majority of the available xR after earning the knockout, but Covington also leaves with some xR for his efforts.
...
ggplot(plot_df, aes(x = FightOfCareer, y = F1_cumulative_Xrp, color = F1_Name)) + 
  ...
  labs(title = 'xR% of Men\'s UFC Pound-for-Pound Top 5', 
       subtitle = 'Rankings taken as of March 2, 2021',
       x = '\nFight of UFC career', 
       y = 'Cumulative xR%\n') + 
  theme_bw() + 
