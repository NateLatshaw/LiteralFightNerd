...
ggplot(plot_df[FightOfCareer <= 10 & FightOfCareer > 0], aes(x = FightOfCareer, y = value, color = variable_color, lty = variable_line)) + 
  ...
  scale_y_continuous(breaks = seq(-1, 1, .05), limits = c(-.1, .4)) + 
